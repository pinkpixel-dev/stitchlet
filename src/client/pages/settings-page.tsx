    ...
    <section className="space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_22rem]">
        <section className="rounded-lg border border-[var(--border)] bg-[var(--shell)] p-5">
          ...
          <div className="mt-5 flex items-center justify-between gap-4 rounded-md border border-[var(--border)] bg-[var(--surface)] p-4">
            <div className="flex items-center gap-3">
              <SunMoon className="text-[var(--accent-purple)]" size={20} />
              <div>
                <p className="font-medium">Theme</p>
                <p className="mt-1 text-sm text-[var(--muted)]">Default dark mode with a light cream option.</p>
              </div>
            </div>
            <ThemeToggle />
          </div>
        ...
        <aside className="rounded-lg border border-[var(--border)] bg-[var(--shell)] p-5">
          <h2 className="text-base font-semibold">Self-hosted status</h2>
          <div className="mt-4 space-y-3">
            {settings.map((item) => (
              <div className="flex gap-3 rounded-md border border-[var(--border)] bg-[var(--surface)] p-3" key={item.label}>
                <item.icon className="mt-0.5 text-[var(--accent-pink)]" size={18} />
                <div>
